<div align="center">
  <img src="docs/images/berrywave-logo.png" alt="BerryWave Logo" width="100" />
  <h1>BerryWave EDI Python SDK</h1>
  
  <p><i>Convert X12 and EDIFACT EDI documents to JSON using a simple, Python-native API.</i></p>
</div>
